...
- =� **Developer Friendly**: Simple API, functional options pattern
...
|---------|----------|------------------|-----|
| Cookie encryption |  AES-GCM |  AES | L |
| Redis support |  Optional |  Required |  |
| Flash messages |  Built-in |  | L |
| Session rotation |  Automatic/Manual | L | L |
| Gin integration |  Separate package | L | L |
| Functional options |  | L |  |
...
Made with d by [abmcmanu](https://github.com/abmcmanu)